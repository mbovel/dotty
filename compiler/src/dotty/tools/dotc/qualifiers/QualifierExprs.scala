          ...
          fun match
            ...
            case Select(qualifier, name)
              ...
              name match
                case nme.EQ  => Equal(lhs, rhs)
                case nme.NE  => Not(Equal(lhs, rhs))
                case nme.GT  => and(Not(Equal(lhs, rhs)), GreaterThanOrEqual(lhs, rhs))
                case nme.GE  => GreaterThanOrEqual(lhs, rhs)
                case nme.LT  => Not(GreaterThanOrEqual(lhs, rhs))
                case nme.LE  => Not(and(Not(Equal(lhs, rhs)), GreaterThanOrEqual(rhs, lhs)))
