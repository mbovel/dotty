...
def Test =
  ...
  if(n.isInstanceOf[String] && n.asInstanceOf[String] != "") then println("n is not empty")
  else println("n is empty")

  */

  if n.isInstanceOf[{v: String with v != "abc"}] then println("n is a not an empty String")
